...
public class SelectParser extends Parser {
	...
	public static final int
		RULE_parse = 0, RULE_select_list = 1, RULE_expression = 2, RULE_ojb_list = 3, 
		RULE_comparator = 4, RULE_binary = 5, RULE_bool = 6;
	public static final String[] ruleNames = {
		"parse", "select_list", "expression", "ojb_list", "comparator", "binary", 
		"bool"
	};
	...
	public static class InExpressionContext extends ExpressionContext {
		public ExpressionContext left;
		public Ojb_listContext right;
		public TerminalNode IN() { return getToken(SelectParser.IN, 0); }
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
		public Ojb_listContext ojb_list() {
			return getRuleContext(Ojb_listContext.class,0);
		}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 3:
						...
						match(LIKE);
						setState(51);
						((LikeExpressionContext)_localctx).right = expression(7);
						}
						break;
					case 4:
						{
						...
						match(IN);
						setState(54);
						((InExpressionContext)_localctx).right = ojb_list();
						}
						break;
					}
					} 
	...
	public static class Ojb_listContext extends ParserRuleContext {
		public Ojb_listContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_ojb_list; }
	 
		public Ojb_listContext() { }
		public void copyFrom(Ojb_listContext ctx) {
			super.copyFrom(ctx);
		}
	}
	public static class SliteralListContext extends Ojb_listContext {
		public TerminalNode LPAREN() { return getToken(SelectParser.LPAREN, 0); }
		...
		public TerminalNode RPAREN() { return getToken(SelectParser.RPAREN, 0); }
		public SliteralListContext(Ojb_listContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class DecimalListContext extends Ojb_listContext {
		public TerminalNode LPAREN() { return getToken(SelectParser.LPAREN, 0); }
		...
		public TerminalNode RPAREN() { return getToken(SelectParser.RPAREN, 0); }
		public DecimalListContext(Ojb_listContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public final Ojb_listContext ojb_list() throws RecognitionException {
		Ojb_listContext _localctx = new Ojb_listContext(_ctx, getState());
		enterRule(_localctx, 6, RULE_ojb_list);
		int _la;
		try {
			setState(80);
	...
	public static final String _serializedATN =
		...
		"\3\7\3\b\3\b\3\b\2\3\6\t\2\4\6\b\n\f\16\2\5\3\2\r\23\3\2\6\7\3\2\t\n`"+
		"\2\20\3\2\2\2\4\26\3\2\2\2\6)\3\2\2\2\bR\3\2\2\2\nT\3\2\2\2\fV\3\2\2\2"+
		"\16X\3\2\2\2\20\21\7\3\2\2\21\22\5\4\3\2\22\23\7\4\2\2\23\24\5\6\4\2\24"+
		"\25\7\2\2\3\25\3\3\2\2\2\26\33\7\27\2\2\27\30\7\5\2\2\30\32\7\27\2\2\31"+
		"\27\3\2\2\2\32\35\3\2\2\2\33\31\3\2\2\2\33\34\3\2\2\2\34\5\3\2\2\2\35"+
		"\33\3\2\2\2\36\37\b\4\1\2\37 \7\b\2\2 *\5\6\4\13!\"\7\24\2\2\"#\5\6\4"+
		"\2#$\7\25\2\2$*\3\2\2\2%*\5\16\b\2&*\7\27\2\2\'*\7\26\2\2(*\7\30\2\2)"+
		"\36\3\2\2\2)!\3\2\2\2)%\3\2\2\2)&\3\2\2\2)\'\3\2\2\2)(\3\2\2\2*;\3\2\2"+
		"\2+,\f\n\2\2,-\5\n\6\2-.\5\6\4\13.:\3\2\2\2/\60\f\t\2\2\60\61\5\f\7\2"+
		"\61\62\5\6\4\n\62:\3\2\2\2\63\64\f\b\2\2\64\65\7\13\2\2\65:\5\6\4\t\66"+
		"\67\f\7\2\2\678\7\f\2\28:\5\b\5\29+\3\2\2\29/\3\2\2\29\63\3\2\2\29\66"+
		"\3\2\2\2:=\3\2\2\2;9\3\2\2\2;<\3\2\2\2<\7\3\2\2\2=;\3\2\2\2>?\7\24\2\2"+
		"?D\7\30\2\2@A\7\5\2\2AC\7\30\2\2B@\3\2\2\2CF\3\2\2\2DB\3\2\2\2DE\3\2\2"+
		"\2EG\3\2\2\2FD\3\2\2\2GS\7\25\2\2HI\7\24\2\2IN\7\26\2\2JK\7\5\2\2KM\7"+
		"\26\2\2LJ\3\2\2\2MP\3\2\2\2NL\3\2\2\2NO\3\2\2\2OQ\3\2\2\2PN\3\2\2\2QS"+
		"\7\25\2\2R>\3\2\2\2RH\3\2\2\2S\t\3\2\2\2TU\t\2\2\2U\13\3\2\2\2VW\t\3\2"+
		"\2W\r\3\2\2\2XY\t\4\2\2Y\17\3\2\2\2\t\33)9;DNR";
